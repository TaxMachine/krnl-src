...
// Controls.MonacoCustomTabControl
using System;
...
public class MonacoCustomTabControl : TabControl
{
	...
	public void InitializeChromium()
	{
		...
		browser.add_LoadingStateChanged((EventHandler<LoadingStateChangedEventArgs>)delegate(object o, LoadingStateChangedEventArgs e)
		{
			if (!e.get_IsLoading())
			{
				Invoke((MethodInvoker)delegate
