...
// Controls.MonacoCustomTabControl_BCKUP
using System;
...
public class MonacoCustomTabControl_BCKUP : TabControl
{
	...
	public ChromiumWebBrowser addnewtab()
	{
		...
		chrome.add_LoadingStateChanged((EventHandler<LoadingStateChangedEventArgs>)delegate(object o, LoadingStateChangedEventArgs e)
		{
			if (!e.get_IsLoading())
			{
				Invoke((MethodInvoker)delegate
	...
	{
		WebBrowser webBrowser = tab.Controls[0] as WebBrowser;
